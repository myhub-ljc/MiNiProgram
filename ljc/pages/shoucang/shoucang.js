...
Page({
  ...
  data: {
    ...
    shoucang_card:[
      {
        content_image:"/images/post/1.jpg",
        title:"高中的最后一场球赛",
        authorName:"秃头的科比",
        date:"2018-04-24"
      },
      {
        content_image: "/images/post/3.jpg",
        title: "与好友的happy",
        authorName: "秃头的科比",
        date: "2018-12-24"
      },
      {
        content_image: "/images/post/2.jpg",
        title: "大学第一次回母校",
        authorName: "秃头的科比",
        date: "2019-04-24"
      },
      {
        content_image: "/images/post/4.jpg",
        title: "难以忘怀的卡纳蓝",
        authorName: "秃头的科比",
        date: "2020-03-24"
      }
  ...
  query: function(event) {
     ...
     */
    wx.request({
      url: 'http://www.hukehuke.vip/login' + this.data.inputValue + /0/,
      data: {
